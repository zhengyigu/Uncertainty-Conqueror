...
from habitat_sim.utils.common import quat_to_magnum, quat_from_angle_axis
...
class GreedyGeodesicFollower:
    ...
    def find_path(self, goal_pos: np.ndarray, angle) -> List[Any]:
        ...
        if len(path) > 500:
            path = ['move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'turn_right', 'move_forward', 'move_forward', 'turn_right', 'turn_right', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'turn_right', 'turn_right', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', 'move_forward', None]
